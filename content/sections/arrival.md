checkin: Check-in is from 4pm. Message on the day if you'd like to check earlier. 1

keybox: Key box code: 2016 1
...
directions2: If travelling from the Glasgow direction, we recommend entering Luss Estates, G83 8RH into Google Maps.

directions3: Continue past the green Luss Estates sign. Just under one kilometre later, take the very first left turn.
